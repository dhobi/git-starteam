...
public class CommitTest {
	...
	public void testCommitReferencedBlob() throws IOException {
		...
		assertEquals(
				...
				"committer Me Tester <Me.tester@domain.com> 1355795 "+DateUtil.getCurrentTimezoneOffset()+"\n" +
	...
	public void testCommitFromWithCopy() throws IOException {
		...
		assertEquals(
				...
				"committer Me Tester <Me.tester@domain.com> 1357595 "+DateUtil.getCurrentTimezoneOffset()+"\n" +
				"data 13\nOther message\n" +
				"from " + cmt.getMarkID() + "\n" +
	...
	public void testCommitInlineFileResume() throws IOException {
		...
		assertEquals(
				...
				"committer Me Tester <Me.tester@domain.com> 1359395 "+DateUtil.getCurrentTimezoneOffset()+"\n" +
				"data 11\nInline Data\n" +
	...
	public void testCommitFromSomeone() throws IOException {
		...
		assertEquals(
				...
				"author Other Tester <Other.Tester@domain.com> 1361195 "+DateUtil.getCurrentTimezoneOffset()+"\n" +
				"committer Me Tester <Me.tester@domain.com> 1361195 "+DateUtil.getCurrentTimezoneOffset()+"\n" +
				"data 15\nAn other branch\n" +
	...
	public void testMergeCommit() throws IOException {
		...
		assertEquals(
				...
				"committer Me Tester <Me.tester@domain.com> 1362995 "+DateUtil.getCurrentTimezoneOffset()+"\n" +
				"data 13\nmerge branchA\n" +
